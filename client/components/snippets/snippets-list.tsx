...
import SnippetListItem from "./snippets-list-item";
import Picker from "../ui/picker";
import SearchBar from "../ui/search-bar";
import { ArrowsUpDownIcon, FilterIcon, TagIcon } from "../ui/icons";
...
export default function SnippetsList() {
  ...
  const [loading, toggleLoading] = useBool(true);
  ...
  const FilterButton = () => {
    ...
    return (
      <Picker value={sortBy} opts={Object.values(filterOptLabel)} onSelect={handleOptSelect}>
  ...
  const OrderButton = () => {
    ...
    return (
      <Picker value={sortOrder} opts={["Ascending", "Descending"]} onSelect={handleOptSelect}>
